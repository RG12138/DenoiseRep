...
class Block(nn.Module):
    ...
    def forward(self, x, t1 = None, t2 = None, t3 = None, denoise1 = None, denoise2 = None):
...
class TransReID(nn.Module):
    ...
    def forward_features(self, x, denoise_model_list = None, camera_id = None, view_id = None):
        B = x.shape[0]
    ...
    def forward(self, x, denoise_model_list = None, cam_label=None, view_label=None):
        x = self.forward_features(x, denoise_model_list, cam_label, view_label)
        return x
